#!/bin/bash
#SBATCH --job-name=osm-prepare
#SBATCH --output=./log/preprocess/osm/%x-%j.out
#SBATCH --error=./log/preprocess/osm/%x-%j.err
...
/scicore/home/meiera/schulz0022/miniforge-pypy3/envs/src/bin/python "/scicore/home/meiera/schulz0022/projects/growth-and-temperature/run.py" pipeline run \
    ...
    --temp-dir "/scratch/schulz0022/osm_${SLURM_JOB_ID}" \
    --dashboard-port 8787 \
    --debug
