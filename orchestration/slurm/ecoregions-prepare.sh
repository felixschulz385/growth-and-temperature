#!/bin/bash
#SBATCH --job-name=ecoregions-prepare
#SBATCH --output=./log/preprocess/ecoregions/%x-%j.out
#SBATCH --error=./log/preprocess/ecoregions/%x-%j.err
...
mkdir -p "./log/preprocess/ecoregions"
...
/scicore/home/meiera/schulz0022/miniforge-pypy3/envs/src/bin/python "/scicore/home/meiera/schulz0022/projects/growth-and-temperature/run.py" data run \
    ...
    --temp-dir "/scratch/schulz0022/ecoregions_${SLURM_JOB_ID}" \
    --dashboard-port 8787 \
    --debug
