#!/bin/bash
#SBATCH --job-name=eog-dvnl-grid
#SBATCH --output=./log/preprocess/eog_dvnl/%x-%j.out
#SBATCH --error=./log/preprocess/eog_dvnl/%x-%j.err
...
mkdir -p "./log/preprocess/eog_dvnl"
...
/scicore/home/meiera/schulz0022/miniforge-pypy3/envs/src/bin/python "/scicore/home/meiera/schulz0022/projects/growth-and-temperature/run.py" pipeline run \
    ...
    --temp-dir "/scratch/schulz0022/eog_dvnl_${SLURM_JOB_ID}" \
    --dashboard-port 8787 \
    --debug
