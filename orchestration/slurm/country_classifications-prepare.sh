#!/bin/bash
#SBATCH --job-name=country_classifications-prepare
#SBATCH --output=./log/preprocess/country_classifications/%x-%j.out
#SBATCH --error=./log/preprocess/country_classifications/%x-%j.err
...
mkdir -p "./log/preprocess/country_classifications"
