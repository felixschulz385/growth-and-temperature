...
/scicore/home/meiera/schulz0022/miniforge-pypy3/envs/gnt/bin/python -m src.cli data run \
...
/scicore/home/meiera/schulz0022/miniforge-pypy3/envs/gnt/bin/python -m src.cli data transfer \
    --config "/scicore/home/meiera/schulz0022/projects/growth-and-temperature/orchestration/configs/data.yaml" \
    --source modis \
    --step fetch \
    --direction push
