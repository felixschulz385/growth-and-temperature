...
def _project_root() -> Path:
    """Return the project root directory (two levels above src/cli)."""
...
def handle_run(args: argparse.Namespace) -> None:
    ...
    from src.analysis import AnalysisConfig, run_duckreg
...
def handle_submit(args: argparse.Namespace) -> None:
    ...
    from src.analysis import AnalysisConfig
    from src.analysis.core.config import seconds_to_slurm_time, PROJECT_ROOT
    from src.analysis.orchestration.slurm import (
...
def handle_summary(args: argparse.Namespace) -> None:
    ...
    from src.analysis import AnalysisConfig, summarize_tables
...
def handle_tables(args: argparse.Namespace) -> None:
    ...
    from src.analysis import AnalysisConfig, generate_all_tables
...
def handle_cleanup(args: argparse.Namespace) -> None:
    ...
    from src.analysis import cleanup_analysis_results
...
def handle_subsets_generate(args: argparse.Namespace) -> None:
    ...
    from src.analysis.subsets import generate_all_default_subsets
...
def handle_subsets_list(args: argparse.Namespace) -> None:
    ...
    from src.analysis.subsets import list_available_subsets
