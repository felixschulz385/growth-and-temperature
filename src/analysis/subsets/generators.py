...
shared :class:`~src.analysis.subsets.registry.CountryRegistry` and the
canonical schema in :mod:`~src.analysis.subsets.schema`.

Filenames are part of an implicit contract with ``SUBSET_ALIASES``
(:mod:`src.analysis.subsets.resolve`) and with any spatial-extent values
