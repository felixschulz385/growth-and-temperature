...
# CANONICAL_PARTITIONED_SPATIAL_EXTENT_RE is imported above from src.analysis.subsets
...
# resolution for a canonical subset name lives in src.analysis.subsets.
...
class AnalysisConfig:
    ...
    def get_model_spec(
        ...
        *,
        ...
        :func:`~src.analysis.execution.runner.run_duckreg`:
