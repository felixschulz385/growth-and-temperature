...
# Derived pixel-id grid labels -> resolution in **metres** on the canonical
# EPSG:6933 grid (the assemble engine coarsens by an integer factor of the
# native 1 km cell). `normalize_derived_pixel_id_specs` also accepts a bare
# number, read as metres.
