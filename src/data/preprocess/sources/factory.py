...
def get_preprocessor_class(preprocessor_name: str) -> Type:
    ...
    try:
        ...
        if preprocessor_name == 'eog':
            ...
            module_path = f"src.data.preprocess.sources.glass"
        elif preprocessor_name in ['ntl_harm', 'ntlharm', 'harmonized_ntl']:
            class_name = 'NTLHarmPreprocessor'
            module_path = f"src.data.preprocess.sources.ntl_harm"
            ...
            module_path = f"src.data.preprocess.sources.{preprocessor_name.lower()}"
