"""GlassSource._plan_fetch()'s remote-aware completeness check
...
with an HPC target configured should judge a (year, day) "already fetched"
against the HPC listing instead of local disk.
"""
